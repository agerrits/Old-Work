<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                ...
                xmlns:ns1="http://domain.com/purchaseFRequest"
                xmlns:htdp="http://www.example.org/WS-HT/protocol"
                xmlns:api="http://www.example.org/WS-HT/api"
                xmlns:trt="http://schemas.active-endpoints.com/b4p/wshumantask/2007/10/aeb4p-task-rt.xsd"
                xmlns:ns="http://PurchaseRequest"
                xmlns:aemeta="urn:ae:xslrendering:meta"
                aemeta:operation="purchaseRequest"
                aemeta:portType="ns1:checkCorrectRequest"
                aemeta:processName="ns:PurchaseRequest"
                aemeta:projectName="PurchaseRequest"
                aemeta:taskName="CheckCorrect"
   ...
   <!-- Template for rendering task input section --><xsl:template name="ae_task_workitem_inputsection" xml:space="default">
      ...
      <!-- Input: --><div id="workitemdata_inputsection" style="width:100%;">
         <table class="workitem_table">
            ...
            <tr>
               <td colspan="2">
                  <div xmlns:ns="http://domain.com/CheckRequest" class="aepart"
                       id="aepart_purchaseRequestRequest">
                     <xsl:variable name="purchaseRequestRequest_ns_date"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:date"/>
                     <xsl:variable name="purchaseRequestRequest_ns_by"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:by"/>
                     <xsl:variable name="purchaseRequestRequest_ns_vendor"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:vendor"/>
                     <xsl:variable name="purchaseRequestRequest_ns_reason"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:reason"/>
                     <xsl:variable name="purchaseRequestRequest_ns_shipping"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:shipping"/>
                     <xsl:variable name="purchaseRequestRequest_ns_eta"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:eta"/>
                     <xsl:variable name="purchaseRequestRequest_ns_approved"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:approved"/>
                     <xsl:variable name="purchaseRequestRequest_ns_comments"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Header/ns:comments"/>
                     <xsl:variable name="purchaseRequestRequest_ns_item_attr_LineNum"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/@LineNum"/>
                     <xsl:variable name="purchaseRequestRequest_ns_productNo"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/ns:productNo"/>
                     <xsl:variable name="purchaseRequestRequest_ns_description"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/ns:description"/>
                     <xsl:variable name="purchaseRequestRequest_ns_quantity"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/ns:quantity"/>
                     <xsl:variable name="purchaseRequestRequest_ns_price"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/ns:price"/>
                     <xsl:variable name="purchaseRequestRequest_ns_total"
                                   select="//trt:operational/trt:input/trt:part[@name='purchaseRequestRequest']/ns:purchaseRequest/ns:Items/ns:item/ns:total"/>
                     <table border="1">
                        <tr>
                           <td colspan="2">
   ...
   <!-- Template for rendering task output section (read-only) --><xsl:template name="ae_task_workitem_outputsection" xml:space="default">
      ...
      <!-- Output section --><div class="aeoutputsection" id="workitemdata_outputsection" style="width:100%;">
         <table class="workitem_table">
            ...
            <tr>
               <td colspan="2">
                  <div xmlns:ns="http://domain.com/CheckResponse" class="aepart"
                       id="aepart_purchaseRequestResponse">
                     <xsl:variable name="purchaseRequestResponse_ns_approved"
                                   select="//trt:operational/trt:output/trt:part[@name='purchaseRequestResponse']/ns:purchaseResponse/ns:approved"/>
                     <table border="1">
                        <tr>
                           <td colspan="2">
                        ...
                        <tr>
                           ...
                           <td>
                              <input class="aestringtype workitemdata_output workitemdata_editable"
                                     id="purchaseRequestResponse_ns_approved"
                                     name="purchaseRequestResponse_ns_approved"
                                     title="Approved (string type)"
                                     type="text">
                                 <xsl:attribute name="value">
                                    <xsl:value-of select="$purchaseRequestResponse_ns_approved"/>
                                 </xsl:attribute>
