<xsl:stylesheet xmlns:aefe="http://schemas.active-endpoints.com/humanworkflow/2007/07/renderxsl/errors" xmlns:aemeta="urn:ae:xslrendering:meta" xmlns:api="http://www.example.org/WS-HT/api" xmlns:htd="http://www.example.org/WS-HT" xmlns:htdp="http://www.example.org/WS-HT/protocol" xmlns:ns="http://PurchaseRequest" xmlns:ns1="http://domain.com/purchaseFRequest/7" xmlns:trt="http://schemas.active-endpoints.com/b4p/wshumantask/2007/10/aeb4p-task-rt.xsd" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" aemeta:operation="purchaseRequest" aemeta:portType="ns1:rfq" aemeta:processName="ns:PurchaseRequest" aemeta:projectName="PurchaseRequest" aemeta:taskName="ReceiveItems" aemeta:templateType="presentation" version="1.0">
   ...
   <xsl:template name="ae_task_workitem_outputsection" xml:space="default">
      ...
      <div class="aeoutputsection" id="workitemdata_outputsection" style="width:100%;">
         <table class="workitem_table">
            ...
            <tr>
               <td colspan="2">
                  <div xmlns:ns="http://domain.com/CheckResponse" class="aepart" id="aepart_purchaseRequestResponse">
                     <xsl:variable name="purchaseRequestResponse_ns_approved" select="//trt:operational/trt:output/trt:part[@name='purchaseRequestResponse']/ns:purchaseResponse/ns:approved"/>
                     <table border="1">
                        <tr>
                           <td colspan="2">
