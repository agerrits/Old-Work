<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
   ...
   <!--
		...
		--><!-- Set output part 'purchaseRequestResponse' --><xsl:template xmlns:ns="http://domain.com/CheckResponse"
                 name="ae_task_workitem_setoutput_part_purchaseRequestResponse"
                 xml:space="default">
      <xsl:variable name="purchaseRequestResponse_ns_approved"
                    select="//aefp:parameters/aefp:parameter[@name='purchaseRequestResponse_ns_approved']"/>
